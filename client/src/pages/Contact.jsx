      ...
      <div className="flex flex-col pt-[4rem] items-center h-screen w-full">
        ...
        <div className="flex flex-col gap-2 sm:mt-[3rem] items-center">
          ...
          <div className=" flex items-center gap-[4rem]">
            ...
            <input type="email" name="email" required className="input-style w-[14rem] sm:w-[18rem]" value={email} onChange={handleEmailChange}/>
          </div>

          <div className=" flex items-center gap-[3.2rem]">
            <label for="subject" className="font-semibold">subject:</label>
            <input type="text" name="subject" required className="input-style w-[14rem] sm:w-[18rem]" value={subject} onChange={handleSubjectChange}/>
          </div>

          <div className=" flex items-center gap-[2.4rem]">
            <label className="font-semibold">Message:</label>
            <textarea name="message" rows="5" required className="input-style w-[14rem] sm:w-[18rem]" value={message} onChange={handlemessageChange}></textarea>
          </div>
            <button type="submit" className="btn-scale py-2 px-10 bg-slate-100 w-[14rem] border-2 border-slate-400 hover:bg-slate-200 font-semibold mt-[1rem] ml-[7rem]" onClick={handleSendBtnClick}>Send Message</button>
          <div className="flex flex-col contact-info items-center gap-4 mt-2">
            <p>Email: contact@skillhub.com</p>
